...
It is, however, going to be helpful, if you have some acknowledge to QR Code.
...
Repacking eveything above into [`Exploit.java`](Solving%20Source%20Code/🎹%20Fallen%20Beat/Exploit.java),
...
so I made my own version with Python, take a look at [`T-Rex.py`](Solving%20Source%20Code/🦖%20T-Rex/T-Rex.py) if you're interested.
